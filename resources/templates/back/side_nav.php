...
<ul class="nav navbar-nav side-nav">
    ...
    <li>
        <a href="index.php?products"><i class="fa fa-fw fa-bar-chart-o"></i> Zobacz produkty</a>
    </li>
    <li>
        <a href="index.php?add_product"><i class="fa fa-fw fa-table"></i> Dodaj produkty</a>
    </li>
